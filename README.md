...
![image](https://github.com/amsacks/Asynchronous-FIFO/blob/main/tb/async_fifo_tb_case1.png)  
  ...
  After 16 write clock cycles with w_en HIGH, the FIFO is full; the last word in the buffer is 22. Therefore, when reading from the FIFO in test case #2, 23 should never   appear
